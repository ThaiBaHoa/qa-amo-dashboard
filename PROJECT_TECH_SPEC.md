...
**Version hiện tại:** `2026.06.05-r93`
**Cập nhật spec:** 2026-06-05 — phản ánh code thực tế (gồm r81–r93, SPI, KPI2, PAVOI RFI)
...
| `APP_REV` | `'2026.06.05-r93'` | version (hiển thị footer + PDF) |
...
- **Versioning:** bump `APP_REV` mỗi thay đổi (`YYYY.MM.DD-rNN`). Hiện r93. (Luôn nối tiếp số thực tế trong file, KHÔNG lùi — vd spec ghi r85 nhưng file đã r86 → bump r87.)
