...
- **Versioning (`APP_REV = YYYY.MM.DD-rNN[-iM]`):** phân biệt **nâng rev** vs **đánh issue** để rev không bị đẩy lên quá cao do mỗi lần vá lỗi.
  ...
  - *Ví dụ:* r107 = tính năng QCS detail (nâng rev). 2 hotfix sau (TDZ trắng data; timeout `report_field`) là **bug fix → Issue 1 & Issue 2 của r107** (`r107-i1`, `r107-i2`), KHÔNG nâng lên r108/r109.
